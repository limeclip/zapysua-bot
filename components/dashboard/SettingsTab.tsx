    ...
    <div className="space-y-4 animate-in fade-in pb-4">
      ...
      <Card className="space-y-3">
        ...
        >
          ...
          <span>{showHours ? <ChevronUp className="size-4" /> : <ChevronDown className="size-4" />}</span>
        </button>
      ...
      <Card className="space-y-3">
        ...
        >
          <span>Профіль</span>
          <span>{showProfile ? <ChevronUp className="size-4" /> : <ChevronDown className="size-4" />}</span>
        </button>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Унікальна адреса вашої сторінки для клієнтів. <br /> Наприклад: t.me/ZapysUaBot?start=ваш_slug <br />або у веб-посиланні. Використовуйте латиницю, цифри або дефіс. Без пробілів. Крапку не можна.
              </p>
              <Input
            ...
            <div className="space-y-2">
              ...
              <Select value={category} onValueChange={(value) => setCategory(value as MasterCategory)}>
      ...
      <Card className="space-y-3">
        ...
        <p className="text-xs text-zinc-500">
          Надішліть це посилання клієнту. Клієнт переходить за ним і одразу потрапляє у ваш профіль у додатку, де може переглянути послуги, ціни та записатися на зручний час.
        </p>
        <p className="text-xs text-zinc-500">
          💡 Також ви можете скопіювати це посилання за допомогою кнопки з іконкою <span className="inline-flex items-center gap-0.5"><LinkIcon className="h-3 w-3" /></span> у верхньому правому куті.
        </p>
  ...
  <>
    ...
    <p className="text-xs text-zinc-500">
      ...
      <Card className="space-y-3">
        ...
        <Select value={tone} onValueChange={(value) => saveTone(value as AiTone)}>
          <SelectTrigger className="w-full bg-transparent border border-border data-[size=default]:h-12">
            <SelectValue placeholder="Оберіть тон спілкування" />
          </SelectTrigger>
          <SelectContent>
