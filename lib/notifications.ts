...
export async function sendBookingConfirmation(
  booking: BookingWithService,
  customer: Pick<Customer, "telegram_id" | "name"> | { telegram_id?: number | null; name: string },
  options?: { timeZone?: string; master?: Pick<Master, "business_name" | "timezone"> },
): Promise<void> {
  await notifyClientBookingStatusChange({
    booking,
    master: {
...
export async function sendBookingCancelled(
  booking: BookingWithService,
  options?: { timeZone?: string; telegramId?: number | null; master?: Pick<Master, "business_name" | "timezone"> },
): Promise<void> {
  await notifyClientBookingStatusChange({
    booking,
    master: {
